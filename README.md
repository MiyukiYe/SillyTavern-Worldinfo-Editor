# 📖 SillyTavern Worldbook Editor (酒馆世界书本地编辑器)

一款专为 SillyTavern（酒馆）跑团/聊天玩家打造的**轻量级、现代化、防丢护航**的本地世界书（Lorebook）编辑器。
...
1. 前往本仓库的 [Releases 页面]([https://www.google.com/search?q=%E5%9C%A8%E8%BF%99%E9%87%8C%E6%8F%92%E5%85%A5%E4%BD%A0%E7%9A%84Releases%E9%93%BE%E6%8E%A5](https://github.com/MiyukiYe/SillyTavern-Worldbook-Editor/releases)) 下载最新版本的 `.exe` 可执行文件。
2. 无需安装任何环境，双击直接运行。
...
> **解决办法：** 点击弹窗上的 `更多信息` -> `仍要运行` 即可。本工具完全开源，所有代码均在 `st_worldbook_editor.py` 中，绝无恶意行为，请放心使用。
...
pyinstaller --noconsole --onefile --hidden-import zhconv --collect-all customtkinter st_worldbook_editor.py
